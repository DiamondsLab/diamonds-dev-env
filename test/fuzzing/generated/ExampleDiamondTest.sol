...
contract ExampleDiamondTest {
     ...
     * @param data Random bytes parameter
     */
    function fuzz_1_owner(address addr1, uint256 val1, bytes memory data) public {
     ...
     * @param data Random bytes parameter
     */
    function fuzz_2_isDeployed(address addr1, uint256 val1, bytes memory data) public {
     ...
     * @param data Random bytes parameter
     */
    function fuzz_3_getSelector(address addr1, uint256 val1, bytes memory data) public {
     ...
     * @param data Random bytes parameter
     */
    function fuzz_4_hasRole(address addr1, uint256 val1, bytes memory data) public {
    ...
    function medusa_facets_valid() public view returns (bool) {
        require(
            address(0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512).code.length > 0,
            "Facet not found"
        );
        require(
            address(0xa513E6E4b8f2a923D98304ec87F64353C4D5C853).code.length > 0,
            "Facet not found"
        );
        require(
            address(0x2279B7A0a67DB372996a5FaB50D91eAA73d2eBe6).code.length > 0,
            "Facet not found"
        );
        require(
            address(0x8A791620dd6260079BF849Dc5567aDC3F2FdC318).code.length > 0,
            "Facet not found"
        );
        require(
            address(0x610178dA211FEF7D417bC0e6FeD39F05609AD788).code.length > 0,
            "Facet not found"
        );
        return true;
    }
