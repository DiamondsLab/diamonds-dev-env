...
4.  **Save PRD:** Save the generated document as `prd-[feature-name].md` inside the `/project` directory.
...
Create an end-to-end project management system improvement for small Security First Development Team without a designated project manager. This should apply to this project using GitHub for code hosting, issues, pull requests, and CI/CD. It should also be portable to other projects that utilize the DevContainer, Diamonds Dev Environment, and other related tools that are part of this setup such as husky, hardhat tests, diamonds-forge for tests, etc. The CI/CD system should be GitHub Actions based. The improvement should focus on templates for issues, pull requests, PRD's, and task lists that can be used to streamline the development process while maintaining a high level of security and code quality. Consider how to best utilize AI tools to assist in code review, testing, and documentation generation within this system. The CI/CD pipeline should include automated security testing and code quality checks utilizing the DevContainer. Provide a detailed outline of the proposed improvements, including specific templates and workflows that can be implemented.
