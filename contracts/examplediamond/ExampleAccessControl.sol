...
/// @title Example Access Control Contract
...
abstract contract ExampleAccessControl is Initializable, AccessControlEnumerableUpgradeable {
    /// @notice Role identifier for the upgrader role.
    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");

    /**
     * @notice Initializes the Example Access Control system.
     ...
     */
    function __ExampleAccessControl_init() internal onlyInitializing onlySuperAdminRole {
        __AccessControlEnumerable_init_unchained();
        __ExampleAccessControl_init_unchained();
    }

    /**
     * @notice Additional initialization logic for the Example Access Control system.
     ...
     */
    function __ExampleAccessControl_init_unchained() internal onlyInitializing {
