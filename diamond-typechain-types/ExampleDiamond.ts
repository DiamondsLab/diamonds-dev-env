...
export interface ExampleDiamondInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "diamondCut"
      | "diamondInitialize000"
      | "diamondInitialize100"
  ...
  encodeFunctionData(
    functionFragment: "diamondInitialize100",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "diamondInitUpgrade100",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ExampleDiamond extends BaseContract {
  connect(runner?: ContractRunner | null): ExampleDiamond;
  waitForDeployment(): Promise<this>;

  interface: ExampleDiamondInterface;
  ...
  diamondInitialize100: TypedContractMethod<[], [void], "nonpayable">;

  diamondInitUpgrade100: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "diamondInitialize100"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "diamondInitUpgrade100"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
